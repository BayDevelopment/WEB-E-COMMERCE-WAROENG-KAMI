                            ...
                            <select name="tahun" class="form-select">
                                ...
                                <?php if (!empty($year_list)): ?>
                                    <?php foreach ($year_list as $y): ?>
                                        <option value="<?= esc($y) ?>" <?= $selected_year == $y ? 'selected' : '' ?>>
                                            <?= esc($y) ?>
                                        </option>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                ...
                <div class="card-body" id="tableCard">
                    <?php if (!empty($data_pemesanan) && is_array($data_pemesanan)): ?>
                        <div class="table-responsive rounded-4 shadow-sm">
                            <table id="tableLaporan" class="table mb-0 text-capitalize align-middle border rounded-4">
                                <thead class="table-light text-center">
                                    <tr>
                                        ...
                                        <th>Status</th>
                                        <th>Tanggal Pemesanan</th> <!-- kolom baru -->
                                    </tr>
                                </thead>
                                <tbody class="text-center">
                                    ...
                                    foreach ($data_pemesanan as $row): ?>
                                        <tr>
                                            ...
                                            <td><?= date('d-m-Y', strtotime($row['created_at'])) ?></td> <!-- Tampilkan tanggal -->
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
